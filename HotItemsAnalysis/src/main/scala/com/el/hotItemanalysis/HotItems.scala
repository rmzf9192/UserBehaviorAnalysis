package com.el.hotItemanalysis
 ...
 */
//定义输入数据的样例类
case class UserBehavior(userId:Long,itemId:Long,cattegoryId:Int,behavior:String,timestamp:Long)
//定义窗口聚合结果样例类
...
object HotItems {
  def main(args: Array[String]): Unit = {
    ...
    properties.setProperty("auto.offset.reset", "latest")
        ...
        val dataStream = env.readTextFile("E:\\study\\idea_workspace_spark\\UserBehaviorAnalysis\\HotItemsAnalysis\\src\\main\\resources\\UserBehavior.csv")
